...
class TradingAgent extends events_1.EventEmitter {
    ...
    constructor(predictionEngine, portfolioManager, orderManager, riskManager) {
        super();
        this.isActive = false;
        this.lastTradeTime = new Map(); // Track last trade time per symbol
        this.lastSignalCache = new Map(); // Cache last signals
        /**
    ...
    async executeTrade(signal) {
        try {
            ...
            const tradeSignal = {
                ...
                side: signal.side, // Cast to compatible type
